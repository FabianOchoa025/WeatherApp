...
import { Sun, Cloud, CloudRain, CloudSnow, Zap, Wind, CloudFog, Droplets} from 'lucide-react'
...
const conditionsCodes = {
  thunderstrm: [200, 201, 202, 210, 211, 212, 221, 230, 231, 232],
  ...
  const getCoords = () => {
    ...
    <div className="bg-sky-300 min-h-screen flex items-center justify-center">
      <div className="flex flex-col items-center gap-4">
        ...
        <span className="text-sky-800 font-semibold text-lg">Cargando...</span>
      </div>
    </div>
  )
  ...
  return (
    <div className="bg-sky-300 min-h-dvh grid place-content-center">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-md">
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-2 border border-gray-300 rounded p-2">
        ...
        <button onClick={getCoords} className="group border border-gray-300 rounded p-2.5 cursor-pointer">
          <LocateFixed className="size-5 text-gray-400 group-hover:text-gray-900 transition-colors duration-300"/>
          <span className="hidden">Geolocalización</span>
        </button>
        </div>

        <div className="mt-4 space-y-4">
          <div className="size-28 bg-gray-300 rounded mx-auto">
            <img src={iconUrl.replace('[icon]', weather.icon)} alt={weather.description} />
          </div>
          <h2 className="text-5xl font-bold flex items-start justify-center">
